...
│  ├─ components/    # React-компоненты с CSS‑модулями
│  ├─ store/         # MobX‑хранилище и связанные файлы
│  ├─ styles/        # общие стили и модули
│  ├─ types/         # типы и интерфейсы
│  └─ App.tsx        # корневой компонент
├─ public/           # статические файлы, попадающие в сборку
├─ tests/            # тесты на Vitest
├─ docs/             # документация и обоснования решений
...
## Используемые паттерны и инструменты

- **React** + **TypeScript** для UI компонентов.
- **MobX** управляет состоянием и сохраняет его в `LocalStorage`.
- **CSS Modules** применяются для стилизации компонентов.
- **Vite** служит сборщиком и средой разработки.
- **Vitest** используется для тестирования.
- **ESLint** и **Prettier** обеспечивают единый стиль кода.
